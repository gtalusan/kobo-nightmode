#ifndef __NICKEL_MXCFB_H__
#define __NICKEL_MXCFB_H__

/* not every one will have mxcfb.h so include it here */
...
#define EPDC_FLAG_USE_DITHERING_Y1 0x2000 /* only for alyssum and above */
...
/* imx6sll */
struct mxcfb_alt_buffer_data_v2 {
	__u32 phys_addr;
	__u32 width;	/* width of entire buffer */
	__u32 height;	/* height of entire buffer */
	struct mxcfb_rect alt_update_region;	/* region within buffer to update */
...
struct mxcfb_update_data_v2 {
	...
	int dither_mode;
	int quant_bit;
	struct mxcfb_alt_buffer_data_v2 alt_buffer_data;
};
...
#define MXCFB_SEND_UPDATE_V2		_IOW('F', 0x2E, struct mxcfb_update_data_v2)
#define MXCFB_WAIT_FOR_UPDATE_COMPLETE	_IOW('F', 0x2F, __u32)
#define MXCFB_WAIT_FOR_UPDATE_COMPLETE_V2	_IOWR('F', 0x2F, struct mxcfb_update_marker_data)
